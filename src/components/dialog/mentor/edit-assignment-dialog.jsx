...
export default function MentorEditAssignmentDialog({
  open = false,
  classId,
  assignment,
  onOpenChange,
  ...
  async function onSubmit(values) {
    ...
    console.log("UPDATE TUGAS DATA: ", updateAssignmentData)
    try {
      const res = await updateAssignment(updateAssignmentData).unwrap()
      console.log("UPDATE TUGAS RESPONSE: ", res)
      form.reset()
      onOpenChange(false)
      Swal.fire({
        icon: "success",
...
MentorEditAssignmentDialog.propTypes = {
  open: PropTypes.bool,
